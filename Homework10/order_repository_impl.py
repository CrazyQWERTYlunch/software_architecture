...
class OrderRepositoryImpl(OrderRepository):
    ...
    def __init__(self, database_name):
        ...
        Аргументы:
        @:param database_name (str): Имя базы данных SQLite.
        """
    ...
    def add_product(self, product: Product) -> None:
        ...
        Аргументы:
        @:param product (Product): Объект товара для добавления.
        """
        try:
            with self.conn:
                self.cursor.execute(
    ...
    def save(self, order: Order, order_items: List[OrderItem]) -> None:
        ...
        @:param order_items (List[OrderItem]): Список объектов элементов заказа для сохранения.
        """
        try:
            with self.conn:
                self.cursor.execute(
