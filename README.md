...
## Задание:
> 1. Была одна главная страница- делаем наброски для друг страниц: Заказ, доставка, и т д в зависимости от темы .
> 2. UML-диаграмма пакетов
> 3. UML-диаграмма системы обновления приложения:
> 4. UML-диаграмма домена (Domain Diagram):
